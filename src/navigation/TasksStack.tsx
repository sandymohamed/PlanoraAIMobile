...
export const TasksStack: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="TaskCreate" component={TaskCreateScreen} options={{ title: t('navigation.newTask') }} />
      <Stack.Screen name="TaskEdit" component={TaskEditScreen} options={{ title: t('navigation.editTask') }} />
      <Stack.Screen name="TaskDetail" component={TaskDetailScreen} options={{ title: t('navigation.task') }} />
    </Stack.Navigator>
  );
};
