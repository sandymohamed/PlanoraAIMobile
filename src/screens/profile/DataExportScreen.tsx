...
import { showError, showConfirmDialog, showSuccess } from '@/components/ConfirmationDialog';
import type { PlanoraExportApiResponse } from '@/types/dataExport';
import { buildExcelBase64, buildWordDocumentHtml, exportFileBaseName } from '@/utils/dataExportFiles';
import { EXPORT_MIME, shareBase64File, shareTextFile } from '@/utils/shareExportFile';
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.body}>
        Download your tasks, goals, alarms, routines, and profile as a real file you can open in Excel,
        Google Sheets, Word, or Google Docs on your phone.
      </Text>
      <Button
      ...
      <Text style={styles.hint}>
        After tapping export, choose where to save or which app should open the file (Files, Drive, Excel,
        Word, etc.).
      </Text>
