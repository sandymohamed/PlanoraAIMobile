...
export const ProfileScreen: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Card elevated>
        <Text style={[styles.name, textDir]}>
      ...
      <MenuItem
        icon="cog-outline"
        label={t("profile.settingsAccount")}
      ...
      <MenuItem
        ...
        label={t("profile.aiWeeklyReview")}
      ...
      <MenuItem
        icon="timer-outline"
        label={t("profile.focusTimers")}
        onPress={() => navigation.navigate("Focus")}
      />
      <MenuItem
        icon="bell-outline"
        label={t("profile.remindersAlarms")}
...
const MenuItem: React.FC<MenuItemProps> = ({
  ...
  return (
    <TouchableOpacity
      style={[
        styles.menuItem,
        highlight && styles.menuHighlight,
